...
public class AppConstant {
    ...
    public static final String SDCARD_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "app";
    ...
    public static final String API_HEALTH_URL = "http://www.tngou.net/api/";
