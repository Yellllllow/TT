...
import com.taiping.app.InsurcenActivity;
import com.taiping.app.PayDemoActivity;
import com.taiping.app.R;
import com.taiping.app.base.ui.BaseFragment;
import com.taiping.app.cache.CacheCleanManager;
import com.taiping.app.db.RealmHelper;
import com.taiping.app.router.Router;
import com.taiping.app.ui.InsuranceMainActivity;
import com.taiping.app.ui.feedback.FeedBackActivity;
import com.taiping.app.util.OSUtil;
import com.taiping.app.view.CarInsurcenActivity;
...
public class SettingFragment extends BaseFragment implements CompoundButton.OnCheckedChangeListener {
    ...
    @Bind(R.id.ll_setting_car_quere)
    LinearLayout llSettingCarQuere;
    ...
    @OnClick({R.id.ll_setting_like_read, R.id.ll_setting_car_quere, R.id.ll_setting_recent_read, R.id.ll_setting_clear, R.id.ll_setting_feedback, R.id.ll_setting_update})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_setting_car_quere:
                //Router.showRecentRead(getActivity());
                Intent intent = new Intent(getActivity(), CarInsurcenActivity.class);
                startActivity(intent);
                break;

            case R.id.ll_setting_recent_read:
                //Router.showRecentRead(getActivity());
                Intent intent1 = new Intent(getActivity(), InsurcenActivity.class);
                startActivity(intent1);
                break;
            case R.id.ll_setting_clear:
                //showClearDialog();
                Intent intent3 = new Intent(getActivity(), PayDemoActivity.class);
                startActivity(intent3);
                break;
            case R.id.ll_setting_update:
                //new UpdateManager(getActivity(), true).checkUpdate();
                Intent intent2 = new Intent(getActivity(), InsuranceMainActivity.class);
