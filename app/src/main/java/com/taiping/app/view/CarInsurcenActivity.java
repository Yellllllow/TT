...
import com.taiping.app.InsuranceDetailActivity;
import com.taiping.app.R;
import com.taiping.app.api.remote.ApiFactory;
import com.taiping.app.base.adapter.MyCarRecyclerAdapter;
...
import com.taiping.app.model.response.fir.CarInsuranceResult;
import com.taiping.app.model.response.fir.CarInsurances;
...
public class CarInsurcenActivity extends BaseActivity {
    ...
    MyCarRecyclerAdapter recycleAdapter;
    ArrayList<CareInsurance> mDatas=new ArrayList<>();
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        editText.setText("410711198206022521");
        button= (Button) findViewById(R.id.bt);
        recycler= (RecyclerView) findViewById(R.id.recycleView);
        recycleAdapter= new MyCarRecyclerAdapter(mDatas,CarInsurcenActivity.this);
        ...
        recycleAdapter.setOnItemClickLitener(new MyCarRecyclerAdapter.OnItemClickLitener()  {
            @Override
            public void onItemClick(View view, int position) {
                CareInsurance careInsurance=mDatas.get(position);
                Intent mIntent=new Intent(CarInsurcenActivity.this,InsuranceDetailActivity.class);
                mIntent.putExtra("data", careInsurance);
    ...
    public void onClick(View v) {
        ...
        ApiFactory.getFirApi()
                .getCarInsurance("http://wxtest.life.cntaiping.com/taipingwx/insurance-policy/vehicle-insurance",code,"1","20")
                ...
                .subscribe(new Subscriber<String>() {
                    ...
                    public void onNext(String response) {
                        ...
                        try {
                            ...
                            CarInsuranceResult carInsuranceResult=new Gson().fromJson(decrypt,CarInsuranceResult.class);
                            if(carInsuranceResult!=null&&carInsuranceResult.getErrorCode()==null) {
                                CarInsurances carInsurances=carInsuranceResult.getData();
                                if(carInsurances!=null&&carInsurances.getCarPolicyList()!=null) {

                                    ArrayList<CareInsurance> list = carInsurances.getCarPolicyList();
                                    if (list != null) {
                                        if (list.size() == 0) {
                                            Toast.makeText(CarInsurcenActivity.this, "没查询到保单", Toast.LENGTH_LONG).show();
                                        } else {
                                            mDatas.clear();
                                            mDatas.addAll(list);
